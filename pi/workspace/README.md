...
| File | Responsibility |
|---|---|
| `index.ts` | Pi command entry — registers `/montflow` + `/workspace` (both launch the web UI) and the merged profile bus API |

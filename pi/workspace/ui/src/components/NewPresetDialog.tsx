 ...
 * controls. The reviewer-group starts EMPTY (no reviewers, no aggregation
 * model) so the preset opens in the `invalid` state (status flips to `valid`
 * as reviewers and the group's aggregation model are set).
 */

...
> = {
  pending: { label: 'pending', className: 'bg-muted text-muted-foreground', Icon: Zap },
  ...
  incomplete: { label: 'incomplete', className: 'bg-amber-500/15 text-amber-600 dark:text-amber-400', Icon: CircleAlert },

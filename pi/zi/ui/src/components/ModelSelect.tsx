...
export function ModelSelect({
  ...
  // default must not masquerade as a selection there, or a required step
  // looks configured while nothing is stored.
  const effectiveId = hideDefault ? value : effectiveModelId(models, selected, value)

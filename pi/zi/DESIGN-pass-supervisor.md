...
| **Canonical review** | The single report the fixer and humans read (`.agents/@montflow/reviews/<name>/<code>.md`). |
...
```text
.agents/@montflow/reviews/<name>/<code>/passes/<cycle>/brief.md
```

 ...
 */
export const isInt: Predicate.Refinement<unknown, number> = (thing: unknown): thing is number =>
  Number.isNumber(thing) && globalThis.Number.isInteger(thing);
 ...
 */
export const isFloat: Predicate.Refinement<unknown, number> = (thing: unknown): thing is number =>
  Number.isNumber(thing) && !globalThis.Number.isInteger(thing) && !globalThis.Number.isNaN(thing);
 ...
 */
export const isPositive: Predicate.Predicate<number> = (n: number): boolean =>
  Number.isNumber(n) && n > 0;
 ...
 */
export const isNegative: Predicate.Predicate<number> = (n: number): boolean =>
  Number.isNumber(n) && n < 0;
 ...
 */
export const isNonNegative: Predicate.Predicate<number> = (n: number): boolean =>
  Number.isNumber(n) && n >= 0;
 ...
 */
export const isNonPositive: Predicate.Predicate<number> = (n: number): boolean =>
  Number.isNumber(n) && n <= 0;
...
} = dual(2, (self: number, by: number): boolean => by % self === 0);
...
} = dual(2, (self: number, of: number): boolean => self % of === 0);

/**
 * Decrements the given number type. Valid inputs include 1 ≤ n ≤ 1024.
 *
 * @template N The number to be decremented.
 * @returns N - 1.
 */

...
Vitest.describe("[runtime] Macro.singleton", () => {
  ...
  Vitest.describe("with constructor", () => {
    Vitest.it(
      "should create a singleton from a constructor with no arguments",
      () => {
        class Counter {
          value = 0;
          increment() {
    ...
    Vitest.it(
      "should create a singleton from a constructor with arguments",
      () => {
        class Config {
          constructor(
            public name: string,
        ...
        const getConfig = Macro.singleton(
          "config-with-args",
          Config,
          "app",
          3000
  ...
  Vitest.describe("with maker function", () => {
    Vitest.it(
      "should create a singleton from a maker function with no arguments",
      () => {
    ...
    Vitest.it(
      "should create a singleton from a maker function with arguments",
      () => {
  ...
  Vitest.describe("error handling", () => {
    Vitest.it(
      "should throw SingletonAlreadyExistsError when registering duplicate id",
      () => {
        class Service {}

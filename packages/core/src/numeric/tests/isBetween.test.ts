...
Vitest.describe("[runtime] Numeric.isBetween", () => {
  ...
  Vitest.describe("non-curried usage", () => {
    Vitest.it(
      "should return true for number within range (default inclusive)",
      () => {
    ...
    Vitest.it(
      "should return true for number at minimum boundary (default inclusive)",
      () => {
    ...
    Vitest.it(
      "should return true for number at maximum boundary (default inclusive)",
      () => {
    ...
    Vitest.describe("with inclusive: true", () => {
      Vitest.it("should include both boundaries", () => {
        Vitest.expect(Numeric.isBetween(1, [1, 10], { inclusive: true })).toBe(
          true
        );
        Vitest.expect(Numeric.isBetween(10, [1, 10], { inclusive: true })).toBe(
          true
        );
        Vitest.expect(Numeric.isBetween(5, [1, 10], { inclusive: true })).toBe(
          true
        );
      });
    });
    ...
    Vitest.describe("with inclusive: false", () => {
      Vitest.it("should exclude both boundaries", () => {
        Vitest.expect(Numeric.isBetween(1, [1, 10], { inclusive: false })).toBe(
          false
        );
        Vitest.expect(
          Numeric.isBetween(10, [1, 10], { inclusive: false })
        ).toBe(false);
        Vitest.expect(Numeric.isBetween(5, [1, 10], { inclusive: false })).toBe(
          true
        );
      });
    });
    ...
    Vitest.describe("with object-based inclusive options", () => {
      ...
      Vitest.it("should default to true for unspecified boundaries", () => {
        Vitest.expect(Numeric.isBetween(1, [1, 10], { inclusive: {} })).toBe(
          true
        );
        Vitest.expect(Numeric.isBetween(10, [1, 10], { inclusive: {} })).toBe(
          true
        );
        Vitest.expect(
          Numeric.isBetween(1, [1, 10], { inclusive: { max: false } })
        ).toBe(true);
        Vitest.expect(
          Numeric.isBetween(10, [1, 10], { inclusive: { min: false } })
        ).toBe(true);
      });
    });
  ...
  Vitest.describe("curried usage", () => {
    ...
    Vitest.it(
      "should work with curried function and object-based inclusive options",
      () => {
  ...
  Vitest.describe("edge cases", () => {
    Vitest.it("should work with zero-width ranges", () => {
      ...
      Vitest.expect(Numeric.isBetween(5, [5, 5], { inclusive: false })).toBe(
        false
      );
    ...
    Vitest.it("should handle very large ranges", () => {
      ...
      Vitest.expect(
        Numeric.isBetween(Numeric.Constructor.MAX_VALUE, largeRange)
      ).toBe(true);
      Vitest.expect(
        Numeric.isBetween(-Numeric.Constructor.MAX_VALUE, largeRange)
      ).toBe(true);
...
Vitest.describe("[types] Numeric.isBetween", () => {
  ...
  Vitest.it(
    "should accept number, range, and options in non-curried form",
    () => {
      type Test = typeof Numeric.isBetween;

...
- Consumes a review file at `.agents/@montflow/reviews/<name>/<code>.md` produced by adversarial-review v3.0.0+ and resolves findings across fix→re-review loops via the shared per-finding `### Discussion` thread.
